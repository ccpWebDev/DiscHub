...
<div id="bubble-container">
  ...
  <h1 class="wlcm text-5xl font-bold text-white mb-4">Welcome to DiscHub</h1>
  <p class="text-lg mb-8 text-white">Please select your role to continue:</p>

  <div class="btn-container">
    <a href="./studentSignin.php">
        <button class="btn">Student Sign in</button>
    </a>

    <a href="./teacherSignin.php">
        <button class="btn">Teacher sign in</button>
    </a>
</div>
</div>
</div>
